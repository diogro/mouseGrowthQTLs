...
stan_model_SUR_HC = stan(file = './SUR_horseShoePlus.stan',
                         data = stan_parameters, chain=10, iter = 100)
...
plotEffectEstimate = function(current_chrom){
    ...
    save_plot(paste0("data/figures/stan_SUR_HCPlus_chrom", current_chrom, ".png"), hc_plot, base_height = 6, base_aspect_ratio = 1.8)
    return(hc_plot)
}
