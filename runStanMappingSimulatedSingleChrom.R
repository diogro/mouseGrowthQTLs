...
true_effects = c(findA(weight_data$WEEK1, weight_data$chrom6_A1, 0.02),
                 findA(weight_data$WEEK2, weight_data$chrom6_A10, 0.02),
                 findA(weight_data$WEEK3, weight_data$chrom6_A13, 0.02),
                 findA(weight_data$WEEK4, weight_data$chrom6_A14, 0.02),
                 findA(weight_data$WEEK5, weight_data$chrom6_A14, 0.02),
                 findA(weight_data$WEEK6, weight_data$chrom6_A13, 0.02),
                 findA(weight_data$WEEK7, weight_data$chrom6_A14, 0.02))
true_effects = data.frame(true_effects, trait = weight_traits[1:7], type = "aditive",
                          marker = c(1, 10, 13, rep(14, 2), 13, 14), chrom = 6)

weight_data$WEEK1 = makeSimData(weight_data$WEEK1, weight_data$chrom6_A1, 0.02)
weight_data$WEEK2 = makeSimData(weight_data$WEEK2, weight_data$chrom6_A10, 0.02)
weight_data$WEEK3 = makeSimData(weight_data$WEEK3, weight_data$chrom6_A13, 0.02)
weight_data$WEEK4 = makeSimData(weight_data$WEEK4, weight_data$chrom6_A14, 0.02)
weight_data$WEEK5 = makeSimData(weight_data$WEEK5, weight_data$chrom6_A14, 0.02)
weight_data$WEEK6 = makeSimData(weight_data$WEEK6, weight_data$chrom6_A13, 0.02)
weight_data$WEEK7 = makeSimData(weight_data$WEEK7, weight_data$chrom6_A14, 0.02)
