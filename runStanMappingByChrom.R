...
growth_mapping = runStanModelFullGenome(growth_data, growth_traits, 600, 200,  TRUE)
...
area_mapping = runStanModelFullGenome(area_data, area_traits, 600, 200, TRUE)
...
necropsy_mapping = runStanModelFullGenome(necropsy_data, necropsy_traits, 600, 200, TRUE)
